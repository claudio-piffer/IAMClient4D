...
type
  ...
  public
    ...
    [MVCSwagSummary('Profile', 'Profile user', 'getUserProfile')]
    [MVCPath('/profile')]
    [MVCHTTPMethod([httpGET])]
...
procedure TMyControllerV1.GetUserProfile;
//var
...
//  //  LResult: TJSONObject;
begin
  // Accesso facile ai claims JWT con helper
  //  LUserID := LClaims.Subject;
  //  LEmail := LClaims.Email;
  //  LRoles := Context.Context.GetJWTRoles;
  //
  //Context.JWT.Audience
//  if Context.Keycloak.RealmAccess.HasRole('uma_authorization') then
//    Render(Context.JWT.ToJSON);

...
{$R-}  // Disable range checking for big integer operations to avoid false positives
       // Range checking is disabled because LockBox3's internal buffer operations
       // trigger range check errors with certain large values, even though the
       // operations are mathematically correct. This is safe because bounds checking
       // is performed at a higher level in the algorithm.
